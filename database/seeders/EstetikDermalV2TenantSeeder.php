...
/** EstetikDermalV2TenantSeeder: alan-tabanlı sayfalar. Her body bloğu kendi field-template'ine bağlı,
...
class EstetikDermalV2TenantSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $hdrTpl=$byvar('estetikdermal-v2-header'); $ftrTpl=$byvar('estetikdermal-v2-footer');
...
EDV2FTRX;
        $pages=[
            ['slug'=>'home','title'=>'Ana Sayfa','order'=>1,'menu'=>true,'vars'=>[
                'v2-s-home-0','v2-s-home-1','v2-s-home-2','v2-s-home-3','v2-s-home-4','v2-s-home-5','v2-s-home-6','v2-s-home-7'
            ]],
            ['slug'=>'hakkimizda','title'=>'Hakkımızda','order'=>2,'menu'=>true,'vars'=>[
                'v2-s-hakkimizda-0','v2-s-hakkimizda-1','v2-s-hakkimizda-2','v2-s-hakkimizda-3','v2-s-hakkimizda-4','v2-s-hakkimizda-5','v2-s-hakkimizda-6'
            ]],
            ['slug'=>'urunler','title'=>'Ürünler','order'=>3,'menu'=>true,'vars'=>[
                'v2-s-urunler-0','v2-s-urunler-1','v2-s-urunler-2','v2-s-urunler-3','v2-s-urunler-4'
            ]],
            ['slug'=>'urun-detay','title'=>'RRS® HA Long Lasting','order'=>99,'menu'=>false,'vars'=>[
                'v2-s-urun-detay-0','v2-s-urun-detay-1','v2-s-urun-detay-2','v2-s-urun-detay-3','v2-s-urun-detay-4'
            ]],
            ['slug'=>'markalar','title'=>'Markalar','order'=>4,'menu'=>true,'vars'=>[
                'v2-s-markalar-0','v2-s-markalar-1','v2-s-markalar-2','v2-s-markalar-3'
            ]],
            ['slug'=>'etkinlikler','title'=>'Kongre & Etkinlikler','order'=>5,'menu'=>true,'vars'=>[
                'v2-s-etkinlikler-0','v2-s-etkinlikler-1','v2-s-etkinlikler-2','v2-s-etkinlikler-3'
            ]],
            ['slug'=>'iletisim','title'=>'İletişim','order'=>6,'menu'=>true,'vars'=>[
                'v2-s-iletisim-0','v2-s-iletisim-1'
            ]],
            ['slug'=>'marka-skintech','title'=>'Skin Tech Pharma Group','order'=>101,'menu'=>false,'vars'=>[
                'v2-s-marka-skintech-0','v2-s-marka-skintech-1','v2-s-marka-skintech-2','v2-s-marka-skintech-3','v2-s-marka-skintech-4','v2-s-marka-skintech-5','v2-s-marka-skintech-6'
            ]],
            ['slug'=>'marka-seffiline','title'=>'Seffiline','order'=>102,'menu'=>false,'vars'=>[
                'v2-s-marka-seffiline-0','v2-s-marka-seffiline-1','v2-s-marka-seffiline-2','v2-s-marka-seffiline-3','v2-s-marka-seffiline-4','v2-s-marka-seffiline-5','v2-s-marka-seffiline-6','v2-s-marka-seffiline-7'
            ]],
            ['slug'=>'marka-aespio','title'=>'Grand Aespio','order'=>103,'menu'=>false,'vars'=>[
                'v2-s-marka-aespio-0','v2-s-marka-aespio-1','v2-s-marka-aespio-2','v2-s-marka-aespio-3','v2-s-marka-aespio-4','v2-s-marka-aespio-5','v2-s-marka-aespio-6'
            ]],
            ['slug'=>'marka-woorhi','title'=>'Woorhi Mechatronics','order'=>104,'menu'=>false,'vars'=>[
                'v2-s-marka-woorhi-0','v2-s-marka-woorhi-1','v2-s-marka-woorhi-2','v2-s-marka-woorhi-3','v2-s-marka-woorhi-4','v2-s-marka-woorhi-5','v2-s-marka-woorhi-6'
            ]],
            ['slug'=>'marka-mi-medical','title'=>'Mi Medical Innovation','order'=>105,'menu'=>false,'vars'=>[
                'v2-s-marka-mi-medical-0','v2-s-marka-mi-medical-1','v2-s-marka-mi-medical-2','v2-s-marka-mi-medical-3','v2-s-marka-mi-medical-4','v2-s-marka-mi-medical-5','v2-s-marka-mi-medical-6'
            ]],
            ['slug'=>'marka-neogenesis','title'=>'Neogenesis','order'=>106,'menu'=>false,'vars'=>[
                'v2-s-marka-neogenesis-0','v2-s-marka-neogenesis-1','v2-s-marka-neogenesis-2','v2-s-marka-neogenesis-3','v2-s-marka-neogenesis-4','v2-s-marka-neogenesis-5','v2-s-marka-neogenesis-6'
            ]],
        ];
        foreach($pages as $p){
            $bodyBlocks=[];
            ...
            Page::updateOrCreate(['slug'=>$p['slug'],'language_id'=>$langId],
                ['title'=>$p['title'],'status'=>'published','show_in_menu'=>$p['menu'],
                 ...
                 'sections_json'=>['version'=>2,'regions'=>[
                   'header'=>[$this->regRow('header',[$this->blk('b_header','estetikdermal-v2-header',$hdrTpl,$hdr,1)])],
                   'body'  =>[$this->regRow('body',$bodyBlocks)],
                   'footer'=>[$this->regRow('footer',[$this->blk('b_footer','estetikdermal-v2-footer',$ftrTpl,$ftr,1)])],
                 ]]]
            );
        }

        $this->command?->info('EstetikDermalV2TenantSeeder: '.count($pages).' sayfa (alan-editli) kuruldu.');
    }
}
