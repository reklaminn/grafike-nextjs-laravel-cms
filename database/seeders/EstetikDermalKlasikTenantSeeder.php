 ...
 * Self-contained: her sayfa = tek content-block, içine tokens+base.css + header + footer GÖMÜLÜ.
 * Slug'lar 'klasik/...' önekli → Tema 2 (kök slug'lar) ile ÇAKIŞMAZ; ikisi yan yana canlı.
...
.reveal{opacity:1 !important;transform:none !important}
  ...
  </header><!-- ===================== PAGE HERO (compact başlık bandı) ===================== -->
...
.reveal{opacity:1 !important;transform:none !important}
  ...
  </header><!-- ===================== PAGE HERO (compact) + BREADCRUMB ===================== -->
        ...
        foreach ($pages as $p) {
            Page::updateOrCreate(['slug'=>$p['slug'],'language_id'=>$langId],
                ['title'=>$p['title'],'status'=>'published','show_in_menu'=>$p['show_in_menu'],
                 ...
                 'sections_json'=>[['id'=>'cb_'.str_replace('/','_',$p['slug']),'type'=>'content-block','variation'=>'free-html',
