...
/**
 * Estetik Dermal — TENANT seeder. TENANT CONTEXT'inde çalıştır:
 *   php artisan tenants:run db:seed --tenants=estetik_dermal -- --class=EstetikDermalTenantSeeder
 *   (veya tenancy()->initialize($tenant) sonrası db:seed --class=EstetikDermalTenantSeeder)
 * Sayfalar + header/footer menü + site ayarları TENANT DB'sine yazılır.
 * Bloklar (chrome + content-block) central'da; önce ThemeSeeder + SectionTemplatesSeeder + ChromeSeeder çalışmış olmalı.
 */
class EstetikDermalTenantSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (! $cb) { $this->command?->warn('content-block yok — önce EstetikDermalChromeSeeder.'); return; }
      ...
      <div class="container" style="display:flex;flex-wrap:wrap;gap:48px;align-items:center;padding:84px 0 92px;">
        <div style="flex:1 1 460px;">
          ...
          <div style="display:flex;gap:14px;flex-wrap:wrap;">
            <a href="urunler.html" style="display:inline-flex;align-items:center;gap:8px;background:var(--color-primary,#E8702A);color:#fff;padding:15px 30px;border-radius:var(--radius-button,999px);font-weight:700;font-size:15px;box-shadow:0 10px 30px rgba(232,112,42,.32);">Ürünleri Keşfet →</a>
    ...
    <section style="padding:84px 0;background:#fff;">
      <div class="container">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:20px;">
          <a href="marka/skintech.html" style="display:block;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #0C6E72;border-radius:0 0 var(--radius-card,18px) var(--radius-card,18px);padding:28px 26px 26px;transition:transform .2s,box-shadow .2s;">
          ...
          <a href="marka/seffiline.html" style="display:block;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #C98A6D;border-radius:0 0 var(--radius-card,18px) var(--radius-card,18px);padding:28px 26px 26px;transition:transform .2s,box-shadow .2s;">
          ...
          <a href="marka/aespio.html" style="display:block;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #6C5CE0;border-radius:0 0 var(--radius-card,18px) var(--radius-card,18px);padding:28px 26px 26px;transition:transform .2s,box-shadow .2s;">
          ...
          <a href="marka/woorhi.html" style="display:block;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #2DA8FF;border-radius:0 0 var(--radius-card,18px) var(--radius-card,18px);padding:28px 26px 26px;transition:transform .2s,box-shadow .2s;">
          ...
          <a href="marka/mi-medical.html" style="display:block;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #C9A24B;border-radius:0 0 var(--radius-card,18px) var(--radius-card,18px);padding:28px 26px 26px;transition:transform .2s,box-shadow .2s;">
    ...
    <section style="padding:84px 0;background:var(--color-secondary,#FBF4EE);">
      <div class="container">
        <div style="display:flex;align-items:flex-end;justify-content:space-between;gap:20px;flex-wrap:wrap;margin-bottom:44px;">
          ...
          <a href="urunler.html" style="color:var(--color-primary,#E8702A);font-weight:700;font-size:15px;white-space:nowrap;">Tüm ürünler →</a>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:24px;">
          <a href="urun-detay.html" style="display:block;background:#fff;border-radius:var(--radius-card,18px);overflow:hidden;border:1px solid var(--border-soft,#ece6df);transition:transform .2s,box-shadow .2s;">
    ...
    <section style="padding:84px 0;background:#fff;">
      <div class="container">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;max-width:940px;margin:0 auto;">
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">İp</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Kanül &amp; İğne Ucu</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Kimyasal Peeling</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Kozmetik</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Kremler</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Mezoterapi</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Mezoterapi Tabancası</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Micro İğneleme</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Otolog Rejeneratif Terapi</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Peeling</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Profesyonel Ürünler</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">RRS</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Terapi</a>
          <a href="urunler.html" class="cat-pill" style="background:#fff;border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:11px 22px;font-weight:600;font-size:15px;color:var(--text-main,#2a2a2a);">Yüz Maskesi</a>
        </div>
      </div>
    </section>
    ...
    <section style="padding:84px 0;background:var(--color-secondary,#FBF4EE);">
      <div class="container" style="display:flex;flex-wrap:wrap;gap:52px;align-items:center;">
        ...
        <div style="flex:1 1 420px;">
          ...
          <a href="hakkimizda.html" style="display:inline-flex;align-items:center;gap:8px;background:var(--color-primary,#E8702A);color:#fff;padding:14px 28px;border-radius:var(--radius-button,999px);font-weight:700;font-size:15px;">Hakkımızda →</a>
        </div>
      </div>
    </section>
...
EDBODY0;
    ...
    (function () {
      var track = document.querySelector('.hero-slides');
      if (!track || track.children.length < 2) return;
      var count = track.children.length, paused = false;
      function go(dir) {
        var i = Math.round(track.scrollLeft / track.clientWidth);
        i = (i + dir + count) % count;
        track.scrollTo({ left: i * track.clientWidth, behavior: 'smooth' });
      }
      ['pointerenter', 'touchstart', 'focusin'].forEach(function (e) { track.addEventListener(e, function () { paused = true; }, { passive: true }); });
      ['pointerleave', 'touchend'].forEach(function (e) { track.addEventListener(e, function () { paused = false; }, { passive: true }); });
      var prev = document.querySelector('.hero-arrow--prev'), next = document.querySelector('.hero-arrow--next');
      if (prev) prev.addEventListener('click', function () { go(-1); });
      if (next) next.addEventListener('click', function () { go(1); });
      setInterval(function () { if (!paused) go(1); }, 4500);
    })();
      ...
      <div class="container" style="padding:54px 0 60px;">
        <nav aria-label="Breadcrumb" style="margin:0 0 18px;">
          <ol style="list-style:none;display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin:0;padding:0;font-size:14px;color:var(--text-soft,#6b6b6b);">
            <li><a href="index.html" style="color:var(--text-soft,#6b6b6b);font-weight:600;">Ana Sayfa</a></li>
...
<!-- ===================== PAGE HERO (compact) ===================== -->
    ...
    <section style="background:#fff;border-bottom:1px solid var(--border-soft,#ece6df);">
      <div class="container" style="display:flex;flex-wrap:wrap;gap:10px;padding:24px 0;">
        <a href="urunler.html" style="display:inline-flex;align-items:center;background:var(--color-primary,#E8702A);color:#fff;border:1.5px solid var(--color-primary,#E8702A);border-radius:999px;padding:9px 20px;font-weight:700;font-size:14px;box-shadow:0 6px 18px rgba(232,112,42,.26);">Tümü</a>
        <a href="urunler.html" style="display:inline-flex;align-items:center;background:#fff;color:var(--text-main,#2a2a2a);border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:9px 20px;font-weight:700;font-size:14px;">Skin Tech</a>
        <a href="urunler.html" style="display:inline-flex;align-items:center;background:#fff;color:var(--text-main,#2a2a2a);border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:9px 20px;font-weight:700;font-size:14px;">Seffiline</a>
        <a href="urunler.html" style="display:inline-flex;align-items:center;background:#fff;color:var(--text-main,#2a2a2a);border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:9px 20px;font-weight:700;font-size:14px;">Grand Aespio</a>
        <a href="urunler.html" style="display:inline-flex;align-items:center;background:#fff;color:var(--text-main,#2a2a2a);border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:9px 20px;font-weight:700;font-size:14px;">Woorhi</a>
        <a href="urunler.html" style="display:inline-flex;align-items:center;background:#fff;color:var(--text-main,#2a2a2a);border:1.5px solid var(--border-soft,#ece6df);border-radius:999px;padding:9px 20px;font-weight:700;font-size:14px;">Mi Medical</a>
      </div>
    </section>
    ...
    <section style="background:radial-gradient(900px 460px at 85% -20%, rgba(244,161,78,.24), transparent 60%), linear-gradient(180deg,#FFFFFF 0%, var(--color-secondary,#FBF4EE) 100%);border-bottom:1px solid var(--border-soft,#ece6df);">
      <div class="container" style="padding:34px 0 30px;">
        <nav aria-label="Breadcrumb" style="font-size:14px;color:var(--text-soft,#6b6b6b);display:flex;flex-wrap:wrap;align-items:center;gap:8px;">
          ...
          <a href="urunler.html" style="color:var(--text-soft,#6b6b6b);font-weight:600;">Ürünler</a>
          <span aria-hidden="true" style="opacity:.5;">/</span>
      ...
      <div class="container" style="display:flex;flex-wrap:wrap;gap:52px;align-items:flex-start;">
        ...
        <div style="flex:1 1 420px;min-width:0;">
          ...
          <div style="display:flex;gap:14px;flex-wrap:wrap;">
            ...
            <a href="iletisim.html" style="display:inline-flex;align-items:center;gap:8px;background:#fff;color:var(--text-main,#2a2a2a);border:1.5px solid var(--border-soft,#ece6df);padding:15px 28px;border-radius:var(--radius-button,999px);font-weight:700;font-size:15px;">Teklif İste</a>
          </div>
      ...
      <div class="container">
        ...
        <!-- ════════════════════════════════════════════════════════════════════
             ...
             (örn. product-melablock-hsp-spf50.jpg, product-benebellum-lumina-vitc.jpg,
              product-atrofillin.jpg) — urunler.html ile aynı görseller tekrar kullanılır.
             PROMPT: "Professional studio product photography of a single medical
    ...
    <section style="padding:72px 0;background:#fff;">
      <div class="container" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(440px,1fr));gap:26px;">
        ...
        <article style="display:flex;flex-direction:column;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #0C6E72;border-radius:var(--radius-card,18px);overflow:hidden;box-shadow:var(--shadow-soft,0 4px 18px rgba(58,58,58,.07));">
          ...
          <a href="marka/skintech.html" style="margin-top:auto;align-self:flex-start;color:var(--color-primary,#E8702A);font-weight:700;font-size:14.5px;">Markayı Keşfet →</a>
        ...
        <article style="display:flex;flex-direction:column;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #C98A6D;border-radius:var(--radius-card,18px);overflow:hidden;box-shadow:var(--shadow-soft,0 4px 18px rgba(58,58,58,.07));">
          ...
          <a href="marka/seffiline.html" style="margin-top:auto;align-self:flex-start;color:var(--color-primary,#E8702A);font-weight:700;font-size:14.5px;">Markayı Keşfet →</a>
        ...
        <article style="display:flex;flex-direction:column;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #6C5CE0;border-radius:var(--radius-card,18px);overflow:hidden;box-shadow:var(--shadow-soft,0 4px 18px rgba(58,58,58,.07));">
          ...
          <a href="marka/aespio.html" style="margin-top:auto;align-self:flex-start;color:var(--color-primary,#E8702A);font-weight:700;font-size:14.5px;">Markayı Keşfet →</a>
        ...
        <article style="display:flex;flex-direction:column;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #2DA8FF;border-radius:var(--radius-card,18px);overflow:hidden;box-shadow:var(--shadow-soft,0 4px 18px rgba(58,58,58,.07));">
          ...
          <a href="marka/woorhi.html" style="margin-top:auto;align-self:flex-start;color:var(--color-primary,#E8702A);font-weight:700;font-size:14.5px;">Markayı Keşfet →</a>
        ...
        <article style="display:flex;flex-direction:column;background:#fff;border:1px solid var(--border-soft,#ece6df);border-top:3px solid #C9A24B;border-radius:var(--radius-card,18px);overflow:hidden;box-shadow:var(--shadow-soft,0 4px 18px rgba(58,58,58,.07));">
          ...
          <a href="marka/mi-medical.html" style="margin-top:auto;align-self:flex-start;color:var(--color-primary,#E8702A);font-weight:700;font-size:14.5px;">Markayı Keşfet →</a>
      ...
      <div class="container">
        <div style="display:flex;flex-wrap:wrap;gap:32px;align-items:center;justify-content:space-between;background:var(--color-secondary,#FBF4EE);border:1px solid var(--border-soft,#ece6df);border-radius:var(--radius-card,18px);padding:clamp(28px,4vw,44px);">
          ...
          <div style="display:flex;gap:14px;flex-wrap:wrap;flex:0 1 auto;">
            ...
            <a href="iletisim.html" style="display:inline-flex;align-items:center;gap:8px;background:#fff;color:var(--text-main,#2a2a2a);border:1.5px solid var(--border-soft,#ece6df);padding:15px 26px;border-radius:var(--radius-button,999px);font-weight:700;font-size:15px;">İletişim →</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section style="position:relative;overflow:hidden;background:radial-gradient(1100px 560px at 82% -8%, rgba(63,191,168,.20), transparent 62%), linear-gradient(180deg,#FFFFFF 0%, var(--color-secondary,#EAF6F4) 100%);">
      ...
      <div class="container" style="position:relative;display:flex;flex-wrap:wrap;gap:48px;align-items:center;padding:80px 0 92px;">
        <div style="flex:1 1 480px;">
          ...
          <div style="display:flex;gap:14px;flex-wrap:wrap;">
            <a href="../urunler.html" style="display:inline-flex;align-items:center;gap:8px;background:var(--color-primary,#0C6E72);color:#fff;padding:15px 30px;border-radius:var(--radius-button,999px);font-weight:700;font-size:15px;box-shadow:0 12px 32px rgba(12,110,114,.30);">Ürünleri Gör →</a>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:24px;">
          ...
          <div style="background:#fff;border:1px solid var(--border-soft,#cfe6e1);border-radius:var(--radius-card,18px);overflow:hidden;">
            ...
            <div style="padding:8px 16px 18px;">
              <a href="../urun-detay.html" class="st-card" style="display:flex;align-items:center;justify-content:space-between;gap:10px;padding:16px 14px;border-radius:12px;border:1px solid transparent;background:var(--color-secondary,#EAF6F4);margin-top:10px;">
          ...
          <div style="background:#fff;border:1px solid var(--border-soft,#cfe6e1);border-radius:var(--radius-card,18px);overflow:hidden;">
            ...
            <div style="padding:8px 16px 18px;">
              <a href="../urun-detay.html" class="st-card" style="display:flex;align-items:center;justify-content:space-between;gap:10px;padding:14px 14px;border-radius:12px;border:1px solid transparent;background:var(--color-secondary,#EAF6F4);margin-top:10px;">
      ...
      <div class="container">
        <div style="display:flex;flex-wrap:wrap;gap:52px;align-items:center;">
          ...
          <div style="flex:1 1 440px;">
            ...
            <a href="../urun-detay.html" style="display:inline-flex;align-items:center;gap:8px;background:var(--color-primary,#0C6E72);color:#fff;padding:14px 30px;border-radius:var(--radius-button,999px);font-weight:700;font-size:15px;box-shadow:0 12px 30px rgba(12,110,114,.28);">Ürün Detayı →</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="koleksiyon" style="padding:32px 0 100px;background:#FFFCFB;">
      <div class="container">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:26px;">
          <!-- SeffiCare -->
          <a href="../urun-detay.html" class="sf-card" style="display:block;background:#fff;border:1px solid var(--border-soft,#EBD9D6);border-radius:28px;padding:36px 30px;transition:transform .25s,box-shadow .25s;">
...
EDBODY8;
        $css8 = <<<'EDPCSS8'
@import url('https://fonts.googleapis.com');
@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=Playfair+Display:wght@500;600&display=swap');
    ...
    <section id="urunler" style="padding:84px 0;background:var(--color-secondary,#F0ECFB);">
      <div class="container">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:24px;">
          ...
          <a href="../urun-detay.html" class="aespio-card" style="display:block;background:#fff;border-radius:24px;overflow:hidden;">
    ...
    <section style="padding:90px 0;background:#fff;">
      ...
      <div class="container" style="display:flex;flex-wrap:wrap;gap:56px;align-items:center;">
        ...
        <div style="flex:1 1 420px;">
          ...
          <a href="../urun-detay.html" style="display:inline-flex;align-items:center;gap:9px;background:var(--grad-aespio,linear-gradient(135deg,#6C5CE0,#21D4B4));color:#fff;padding:15px 32px;border-radius:999px;font-weight:800;font-size:15px;box-shadow:0 14px 36px rgba(108,92,224,.32);">LFL Anchor'ı İncele →</a>
        </div>
      </div>
    </section>
    ...
    <section style="position:relative;overflow:hidden;background:#0B0E14;background-image:radial-gradient(900px 480px at 82% -8%, rgba(45,168,255,.30), transparent 60%),radial-gradient(700px 520px at 8% 110%, rgba(22,224,200,.20), transparent 60%),linear-gradient(180deg,#0B0E14 0%, #10131A 100%);">
      ...
      <div class="container" style="position:relative;display:flex;flex-wrap:wrap;gap:52px;align-items:center;padding:92px 0 100px;">
        <div style="flex:1 1 480px;">
          ...
          <div style="display:flex;gap:14px;flex-wrap:wrap;">
            <a class="wh-link" href="../urun-detay.html" style="display:inline-flex;align-items:center;gap:9px;background:linear-gradient(135deg,#2DA8FF,#16E0C8);color:#0B0E14;padding:15px 30px;border-radius:999px;font-weight:800;font-size:15px;box-shadow:0 0 30px rgba(45,168,255,.45);">Cihazı İncele →</a>
    ...
    <section style="padding:92px 0;background:#0B0E14;background-image:radial-gradient(800px 500px at 100% 50%, rgba(22,224,200,.12), transparent 60%);">
      <div class="container" style="display:flex;flex-wrap:wrap;gap:56px;align-items:center;">
        ...
        <div style="flex:1 1 420px;">
          ...
          <a class="wh-link" href="../urun-detay.html" style="display:inline-flex;align-items:center;gap:9px;background:linear-gradient(135deg,#2DA8FF,#16E0C8);color:#0B0E14;padding:15px 30px;border-radius:999px;font-weight:800;font-size:15px;box-shadow:0 0 30px rgba(45,168,255,.45);">Raffine Detayları →</a>
        </div>
      </div>
    </section>
        ...
        <div style="position:relative;overflow:hidden;border-radius:28px;background:linear-gradient(120deg,#0E2A44 0%,#0B1C2C 45%,#0A2A2A 100%);border:1px solid rgba(45,168,255,.3);padding:clamp(40px,6vw,72px);text-align:center;box-shadow:0 0 60px rgba(45,168,255,.18);">
          ...
          <div style="position:relative;">
            ...
            <div style="display:flex;gap:14px;justify-content:center;flex-wrap:wrap;">
              ...
              <a class="wh-link" href="../urun-detay.html" style="background:rgba(255,255,255,.06);color:#E6EDF5;border:1px solid rgba(255,255,255,.22);padding:15px 32px;border-radius:999px;font-weight:700;font-size:15px;">Cihazı İncele</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container" style="display:flex;flex-wrap:wrap;gap:56px;align-items:center;padding:96px 0 104px;position:relative;">
        <div style="flex:1 1 480px;">
          ...
          <div style="display:flex;gap:16px;flex-wrap:wrap;">
            <a href="../urun-detay.html" style="display:inline-flex;align-items:center;gap:9px;background:var(--mi-gold-grad,linear-gradient(135deg,#C9A24B,#E3C97E));color:#141414;padding:16px 32px;border-radius:999px;font-weight:700;font-size:15px;box-shadow:0 14px 34px rgba(201,162,75,.26);">Pistor Eliance'ı Keşfet →</a>
    ...
    <section style="background:var(--color-secondary,#F7F3EA);padding:104px 0;">
      <div class="container" style="display:flex;flex-wrap:wrap;gap:64px;align-items:center;">
        ...
        <div style="flex:1 1 420px;">
          ...
          <a href="../urun-detay.html" style="display:inline-flex;align-items:center;gap:9px;background:var(--mi-black,#141414);color:var(--color-accent,#E3C97E);border:1px solid var(--color-primary,#C9A24B);padding:15px 30px;border-radius:999px;font-weight:600;font-size:15px;">Ürün Detayını Gör →</a>
        </div>
      </div>
    </section>
...
EDBODY11;
        $css11 = <<<'EDPCSS11'
@import url('https://fonts.googleapis.com');
@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=Playfair+Display:wght@500;600;700&display=swap');
...
EDPCSS11;
        ...
        $pages = [
            ['slug'=>'home','title'=>'Ana Sayfa','sort_order'=>1,'show_in_menu'=>true,'html'=>$body0,'custom_css'=>null,'custom_js'=>$js0],
            ['slug'=>'hakkimizda','title'=>'Hakkımızda','sort_order'=>2,'show_in_menu'=>true,'html'=>$body1,'custom_css'=>null,'custom_js'=>null],
            ['slug'=>'urunler','title'=>'Ürünler','sort_order'=>3,'show_in_menu'=>true,'html'=>$body2,'custom_css'=>null,'custom_js'=>null],
            ['slug'=>'urun-detay','title'=>'RRS® HA Long Lasting','sort_order'=>99,'show_in_menu'=>false,'html'=>$body3,'custom_css'=>null,'custom_js'=>null],
            ['slug'=>'markalar','title'=>'Markalar','sort_order'=>4,'show_in_menu'=>true,'html'=>$body4,'custom_css'=>null,'custom_js'=>null],
            ['slug'=>'etkinlikler','title'=>'Kongre & Etkinlikler','sort_order'=>5,'show_in_menu'=>true,'html'=>$body5,'custom_css'=>null,'custom_js'=>null],
            ['slug'=>'iletisim','title'=>'İletişim','sort_order'=>6,'show_in_menu'=>true,'html'=>$body6,'custom_css'=>null,'custom_js'=>null],
            ['slug'=>'marka/skintech','title'=>'Skin Tech Pharma Group','sort_order'=>101,'show_in_menu'=>false,'html'=>$body7,'custom_css'=>$css7,'custom_js'=>null],
            ['slug'=>'marka/seffiline','title'=>'Seffiline','sort_order'=>102,'show_in_menu'=>false,'html'=>$body8,'custom_css'=>$css8,'custom_js'=>null],
            ['slug'=>'marka/aespio','title'=>'Grand Aespio','sort_order'=>103,'show_in_menu'=>false,'html'=>$body9,'custom_css'=>$css9,'custom_js'=>null],
            ['slug'=>'marka/woorhi','title'=>'Woorhi Mechatronics','sort_order'=>104,'show_in_menu'=>false,'html'=>$body10,'custom_css'=>$css10,'custom_js'=>null],
            ['slug'=>'marka/mi-medical','title'=>'Mi Medical Innovation','sort_order'=>105,'show_in_menu'=>false,'html'=>$body11,'custom_css'=>$css11,'custom_js'=>null],
        ];
        ...
        foreach ($pages as $p) {
            Page::updateOrCreate(
                ...
                [
                    ...
                    'custom_css'=>$p['custom_css'],'custom_js'=>$p['custom_js'],
                    'sections_json'=>[[
                        'id'=>'cb_'.$p['slug'],'type'=>'content-block','variation'=>'free-html',
                        'render_mode'=>'html','section_template_id'=>$cb->id,'is_active'=>true,'sort_order'=>1,
                        'content'=>['html'=>$p['html']],
                    ]],
                ]
            );
        ...
        $header = Menu::updateOrCreate(['location'=>'header','language_id'=>$langId],
            ['name'=>'Header Menü','slug'=>'header','is_active'=>true]);
        $footer = Menu::updateOrCreate(['location'=>'footer','language_id'=>$langId],
            ['name'=>'Footer Menü','slug'=>'footer','is_active'=>true]);
        $hItems = [['Ana Sayfa','/'],['Hakkımızda','/hakkimizda'],['Ürünler','/urunler'],['Markalar','/markalar'],['Etkinlikler','/etkinlikler'],['İletişim','/iletisim']];
        foreach ($hItems as $i=>$it) {
            MenuItem::updateOrCreate(['menu_id'=>$header->id,'title'=>$it[0]],
                ['url'=>$it[1],'sort_order'=>$i+1,'is_active'=>true,'target'=>'_self']);
        }
        foreach ($hItems as $i=>$it) {
            MenuItem::updateOrCreate(['menu_id'=>$footer->id,'title'=>$it[0]],
                ['url'=>$it[1],'sort_order'=>$i+1,'is_active'=>true,'target'=>'_self']);
        }
        ...
        $settings = [
            ...
            ['design.color_primary','#E8702A','design'],
            ['design.color_secondary','#FBF4EE','design'],
            ['design.color_accent','#F4A14E','design'],
            ['theme.header_variant','estetikdermal-header','theme'],
            ['theme.footer_variant','estetikdermal-footer','theme'],
        ];
        foreach ($settings as $s) {
            SiteSetting::updateOrCreate(['key'=>$s[0]],['value'=>$s[1],'group'=>$s[2],'type'=>'text']);
        }

        $this->command?->info('Estetik Dermal tenant: '.count($pages).' sayfa + menüler + ayarlar kuruldu.');
    }
}
