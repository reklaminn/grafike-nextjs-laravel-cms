...
return [
    ...
    /*
     * ID generator: we use slugs (e.g. "nuhcicek") instead of UUIDs
     * so artisan commands and log messages are human-readable.
     * The slug is supplied explicitly when creating tenants.
     */
    'id_generator' => null,
     ...
     */
    'database' => [
        // stancl uses this connection for its own tables (tenants, domains)
        'central_connection' => 'central',

        /**
         * Template connection used to derive per-tenant connections.
         * stancl will clone 'central' and swap the database name.
         */
        'template_tenant_connection' => 'central',

        /**
         * Tenant DB names: prefix + tenant_id + suffix
         * e.g.  tenant_nuhcicek
         */
        'prefix' => 'tenant_',
        'suffix' => '',
